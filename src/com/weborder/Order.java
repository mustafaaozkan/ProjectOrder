...
public class Order {
	...
	public static String cardNumber(int cardType) {
		...
		switch (cardType) {
		case 0:
			cardNumber += 4 + randomZip(15);
			break;
		case 1:
			cardNumber += 5 + randomZip(15);
			break;
		case 2:
			cardNumber += 3 + randomZip(14);
			break;
		}
		return cardNumber;
	}
	...
	public static void main(String[] args) throws InterruptedException {
		System.setProperty("webdriver.chrome.driver",
				"/Users/mozka002/Documents/Selenium dependencies/drivers/chromedriver");
		...
		driver.findElement(By.name("ctl00$MainContent$fmwOrder$txtQuantity")).sendKeys("" + randomQuantity(100));
		driver.findElement(By.name("ctl00$MainContent$fmwOrder$txtName"))
				.sendKeys("John " + randomMiddle(3) + " Smith");
